...
function renderAthletePortal() {
  ...
  if (banner) {
    ...
    banner.innerHTML = activeSession ? `
      ...
      <button class="primary-action compact-action" data-scroll-active-session type="button">Continuar</button>
    ` : "";
  }
...
function renderExerciseProgress() {
  ...
  ` : "<div class='empty-state'>Todavia no hay progreso historico para ese filtro.</div>";
}
