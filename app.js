...
function renderPatients() {
  ...
  const list = state.patients.filter((patient) => patient.name.toLowerCase().includes(query));
      ...
      <article class="entity-card">
        <header>
          <div>
            ...
            <div class="meta-line">${patient.age} anos &middot; ${escapeHtml(patient.phone)} &middot; ${escapeHtml(patient.phase)}</div>
          </div>
          <span class="chip stable">activo</span>
        </header>
        <div class="stats-row">
...
function addExerciseDraft() {
  ...
  const load = $("#exercise-load").value.trim() || "Sin carga";
...
function editDraftExercise(index) {
  ...
  $("#exercise-load").value = dosage.load === "-" ? "" : dosage.load;
